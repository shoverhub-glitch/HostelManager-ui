                  ...
                  <View
                    ...
                    <View style={styles.cardBody}>
                      ...
                      <View style={styles.cardHeader}>
                        <View style={[styles.cardIconBox, { backgroundColor: brandLight }]}>
                          <DoorOpen size={16} color={brandText} strokeWidth={2} />
                        </View>
                      ...
                      <TouchableOpacity
                        ...
                        activeOpacity={0.82}>
                        <Bed size={14} color={colors.white} strokeWidth={2} />
                        <Text style={[styles.viewBedsBtnText, { color: colors.white }]}>
                          View Beds
                        </Text>
                        <ArrowUpRight size={13} color={colors.white} strokeWidth={2} style={{ marginLeft: 'auto' }} />
                      </TouchableOpacity>
        ...
        <View style={[styles.overlay, { backgroundColor: colors.modal.overlay }]}>
          <View style={[styles.deleteSheet, { backgroundColor: cardBg, maxWidth: modalMaxWidth }]}>
            ...
            <View style={[styles.deleteWarning, {
              ...
              <AlertTriangle size={14} color={colors.warning[500]} strokeWidth={2} />
              <Text style={[styles.deleteWarningText, { color: isDark ? colors.warning[300] : colors.warning[700] }]}>
                All beds become available
              </Text>
            </View>
